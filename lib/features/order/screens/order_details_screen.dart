...
import 'package:eliyah_vendeur/common/widgets/input_dialog_widget.dart';
import 'package:eliyah_vendeur/features/order/screens/invoice_print_screen.dart';
import 'package:eliyah_vendeur/features/order/widgets/amount_input_dialogue_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/dialogue_image_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/order_item_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/slider_button_widget.dart';
import 'package:eliyah_vendeur/features/order/widgets/verify_delivery_sheet_widget.dart';
              ...
              Expanded(child: SingleChildScrollView(
                ...
                child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  (order.additionalCharge != null && order.additionalCharge! > 0) ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Expanded(
                      child: Text(
                        Get.find<SplashController>().configModel!.additionalChargeName!, style: robotoRegular,
