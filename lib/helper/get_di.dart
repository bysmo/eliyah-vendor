...
import 'package:eliyah_vendeur/features/addon/domain/repositories/addon_repository.dart';
import 'package:eliyah_vendeur/features/addon/domain/repositories/addon_repository_interface.dart';
import 'package:eliyah_vendeur/features/addon/domain/services/addon_service.dart';
...
import 'package:eliyah_vendeur/features/address/domain/repositories/address_repository.dart';
import 'package:eliyah_vendeur/features/address/domain/repositories/address_repository_interface.dart';
import 'package:eliyah_vendeur/features/address/domain/services/address_service.dart';
import 'package:eliyah_vendeur/features/address/domain/services/address_service_interface.dart';
import 'package:eliyah_vendeur/features/advertisement/controllers/advertisement_controller.dart';
import 'package:eliyah_vendeur/features/advertisement/domain/repositories/advertisement_repository.dart';
import 'package:eliyah_vendeur/features/advertisement/domain/repositories/advertisement_repository_interface.dart';
import 'package:eliyah_vendeur/features/advertisement/domain/services/advertisement_service.dart';
import 'package:eliyah_vendeur/features/advertisement/domain/services/advertisement_service_interface.dart';
import 'package:eliyah_vendeur/features/ai/controllers/ai_controller.dart';
import 'package:eliyah_vendeur/features/ai/domain/repositories/ai_repository.dart';
import 'package:eliyah_vendeur/features/ai/domain/repositories/ai_repository_interface.dart';
import 'package:eliyah_vendeur/features/ai/domain/services/ai_service.dart';
...
import 'package:eliyah_vendeur/features/auth/domain/repositories/auth_repository.dart';
import 'package:eliyah_vendeur/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:eliyah_vendeur/features/auth/domain/services/auth_service.dart';
...
import 'package:eliyah_vendeur/features/banner/domain/repositories/banner_repository.dart';
import 'package:eliyah_vendeur/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:eliyah_vendeur/features/banner/domain/services/banner_service.dart';
...
import 'package:eliyah_vendeur/features/business/domain/repositories/business_repo.dart';
import 'package:eliyah_vendeur/features/business/domain/repositories/business_repo_interface.dart';
import 'package:eliyah_vendeur/features/business/domain/services/business_service.dart';
import 'package:eliyah_vendeur/features/business/domain/services/business_service_interface.dart';
import 'package:eliyah_vendeur/features/campaign/controllers/campaign_controller.dart';
import 'package:eliyah_vendeur/features/campaign/domain/repositories/campaign_repository.dart';
import 'package:eliyah_vendeur/features/campaign/domain/repositories/campaign_repository_interface.dart';
import 'package:eliyah_vendeur/features/campaign/domain/services/campaign_service.dart';
...
import 'package:eliyah_vendeur/features/category/domain/repositories/category_repository.dart';
import 'package:eliyah_vendeur/features/category/domain/repositories/category_repository_interface.dart';
import 'package:eliyah_vendeur/features/category/domain/services/category_service.dart';
...
import 'package:eliyah_vendeur/features/chat/domain/repositories/chat_repository.dart';
import 'package:eliyah_vendeur/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:eliyah_vendeur/features/chat/domain/services/chat_service.dart';
import 'package:eliyah_vendeur/features/chat/domain/services/chat_service_interface.dart';
import 'package:eliyah_vendeur/features/coupon/controllers/coupon_controller.dart';
import 'package:eliyah_vendeur/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:eliyah_vendeur/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:eliyah_vendeur/features/coupon/domain/services/coupon_service.dart';
import 'package:eliyah_vendeur/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:eliyah_vendeur/features/deliveryman/controllers/deliveryman_controller.dart';
import 'package:eliyah_vendeur/features/deliveryman/domain/repositories/deliveryman_repository.dart';
import 'package:eliyah_vendeur/features/deliveryman/domain/repositories/deliveryman_repository_interface.dart';
import 'package:eliyah_vendeur/features/deliveryman/domain/services/deliveryman_service.dart';
...
import 'package:eliyah_vendeur/features/disbursement/domain/repositories/disbursement_repository.dart';
import 'package:eliyah_vendeur/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
import 'package:eliyah_vendeur/features/disbursement/domain/services/disbursement_service.dart';
...
import 'package:eliyah_vendeur/features/forgot_password/domain/repositories/forgot_password_repository.dart';
import 'package:eliyah_vendeur/features/forgot_password/domain/repositories/forgot_password_repository_interface.dart';
import 'package:eliyah_vendeur/features/forgot_password/domain/services/forgot_password_service.dart';
import 'package:eliyah_vendeur/features/forgot_password/domain/services/forgot_password_service_interface.dart';
import 'package:eliyah_vendeur/features/html/controllers/html_controller.dart';
import 'package:eliyah_vendeur/features/html/domain/repositories/html_repository.dart';
import 'package:eliyah_vendeur/features/html/domain/repositories/html_repository_interface.dart';
import 'package:eliyah_vendeur/features/html/domain/services/html_service.dart';
...
import 'package:eliyah_vendeur/features/language/domain/repositories/language_repository.dart';
import 'package:eliyah_vendeur/features/language/domain/repositories/language_repository_interface.dart';
import 'package:eliyah_vendeur/features/language/domain/services/language_service.dart';
import 'package:eliyah_vendeur/features/language/domain/services/language_service_interface.dart';
import 'package:eliyah_vendeur/features/notification/controllers/notification_controller.dart';
import 'package:eliyah_vendeur/features/notification/domain/repositories/notification_repository.dart';
import 'package:eliyah_vendeur/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:eliyah_vendeur/features/notification/domain/services/notification_service.dart';
import 'package:eliyah_vendeur/features/notification/domain/services/notification_service_interface.dart';
import 'package:eliyah_vendeur/features/order/controllers/order_controller.dart';
import 'package:eliyah_vendeur/features/order/domain/repositories/order_repository.dart';
import 'package:eliyah_vendeur/features/order/domain/repositories/order_repository_interface.dart';
import 'package:eliyah_vendeur/features/order/domain/services/order_service.dart';
import 'package:eliyah_vendeur/features/order/domain/services/order_service_interface.dart';
import 'package:eliyah_vendeur/features/payment/controllers/payment_controller.dart';
import 'package:eliyah_vendeur/features/payment/domain/repositories/payment_repository.dart';
import 'package:eliyah_vendeur/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:eliyah_vendeur/features/payment/domain/services/payment_service.dart';
...
import 'package:eliyah_vendeur/features/profile/domain/repositories/profile_repository.dart';
import 'package:eliyah_vendeur/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:eliyah_vendeur/features/profile/domain/services/profile_service.dart';
import 'package:eliyah_vendeur/features/profile/domain/services/profile_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/reports/controllers/taxi_report_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/reports/domain/repositories/taxi_report_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/reports/domain/repositories/taxi_report_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/reports/domain/services/taxi_report_service.dart';
import 'package:eliyah_vendeur/features/rental_module/reports/domain/services/taxi_report_service_interface.dart';
import 'package:eliyah_vendeur/features/reports/controllers/report_controller.dart';
import 'package:eliyah_vendeur/features/reports/domain/repositories/report_repository.dart';
import 'package:eliyah_vendeur/features/reports/domain/repositories/report_repository_interface.dart';
import 'package:eliyah_vendeur/features/reports/domain/services/report_service.dart';
...
import 'package:eliyah_vendeur/features/splash/domain/repositories/splash_repository.dart';
import 'package:eliyah_vendeur/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:eliyah_vendeur/features/splash/domain/services/splash_service.dart';
...
import 'package:eliyah_vendeur/features/store/domain/repositories/store_repository.dart';
import 'package:eliyah_vendeur/features/store/domain/repositories/store_repository_interface.dart';
import 'package:eliyah_vendeur/features/store/domain/services/store_service.dart';
import 'package:eliyah_vendeur/features/store/domain/services/store_service_interface.dart';
import 'package:eliyah_vendeur/features/subscription/controllers/subscription_controller.dart';
import 'package:eliyah_vendeur/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:eliyah_vendeur/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:eliyah_vendeur/features/subscription/domain/services/subscription_service.dart';
import 'package:eliyah_vendeur/features/subscription/domain/services/subscription_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/banner/controllers/taxi_banner_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/banner/domain/repositories/taxi_banner_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/banner/domain/repositories/taxi_banner_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/banner/domain/services/taxi_banner_service.dart';
import 'package:eliyah_vendeur/features/rental_module/banner/domain/services/taxi_banner_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/chat/controllers/taxi_chat_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/chat/domain/repositories/taxi_chat_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/chat/domain/repositories/taxi_chat_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/chat/domain/services/taxi_chat_service.dart';
import 'package:eliyah_vendeur/features/rental_module/chat/domain/services/taxi_chat_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/coupon/controllers/taxi_coupon_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/coupon/domain/repositories/taxi_coupon_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/coupon/domain/repositories/taxi_coupon_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/coupon/domain/services/taxi_coupon_service.dart';
import 'package:eliyah_vendeur/features/rental_module/coupon/domain/services/taxi_coupon_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/driver/controllers/driver_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/driver/domain/repositories/driver_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/driver/domain/repositories/driver_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/driver/domain/services/driver_service.dart';
...
import 'package:eliyah_vendeur/features/rental_module/profile/domain/repositories/taxi_profile_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/profile/domain/repositories/taxi_profile_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/profile/domain/services/taxi_profile_service.dart';
import 'package:eliyah_vendeur/features/rental_module/profile/domain/services/taxi_profile_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/provider/controllers/provider_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/provider/domain/repositories/provider_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/provider/domain/repositories/provider_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/provider/domain/services/provider_service.dart';
import 'package:eliyah_vendeur/features/rental_module/provider/domain/services/provider_service_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/trips/controllers/trip_controller.dart';
import 'package:eliyah_vendeur/features/rental_module/trips/domain/repositories/trip_repository.dart';
import 'package:eliyah_vendeur/features/rental_module/trips/domain/repositories/trip_repository_interface.dart';
import 'package:eliyah_vendeur/features/rental_module/trips/domain/services/trip_service.dart';
